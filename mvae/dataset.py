...
def dataset_builder(
    ...
    if directory:
        ...
        dataset_size_training = int(float(dataset_size) * 0.9)
        dataset_size_testing = dataset_size - dataset_size_training
        logger.info(f"dataset size: [{dataset_size}]")
        logger.info(f"training size: [{dataset_size_training}]")
        logger.info(f"testing size: [{dataset_size_testing}]")
    else:
